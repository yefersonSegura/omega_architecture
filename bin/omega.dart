...
class OmegaAiCommand {
  /// Models must follow package exports + attached examples only (no invented Omega APIs).
...
''';
  ...
  /// Short OMEGA API block for heal prompts only (replaces full master checklist + long duplicate API list).
