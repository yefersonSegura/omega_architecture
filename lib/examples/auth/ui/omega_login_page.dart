...
class OmegaLoginPage extends StatefulWidget {
  final OmegaFlowManager flowManager; // ✔ Nuevo argumento

  const OmegaLoginPage({super.key, required this.flowManager});
...
class _OmegaLoginPageState extends State<OmegaLoginPage> {
  ...
  void initState() {
    ...
    // obtener el flow registrado por el manager
    flow = widget.flowManager.getFlow("authFlow") as AuthFlow;
  ...
  void _login() {
    ...
    widget.flowManager.handleIntent(intent);
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              widget.flowManager.handleIntent(
